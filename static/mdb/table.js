...
!function (n) {
    ...
    function Yt(t, e, n) {
        var a = t._iDisplayStart, r = t._iDisplayLength, o = t.fnRecordsDisplay(),
            o = (0 === o || -1 === r ? a = 0 : "number" == typeof e ? o < (a = e * r) && (a = 0) : "اول" == e ? a = 0 : "<" == e ? (a = 0 <= r ? a - r : 0) < 0 && (a = 0) : ">" == e ? a + r < o && (a += r) : "آخر" == e ? a = Math.floor((o - 1) / r) * r : W(t, 0, "Unknown paging action: " + e, 5), t._iDisplayStart !== a);
    ...
    var Ie = [], o = Array.prototype, B = function (t, e) {
        ...
        oLanguage: {
            ...
            oPaginate: {sFirst: "اول", sLast: "آخر", sNext: ">", sPrevious: "<"},
            sEmptyTable: "هیچ داده ای موجود نمی باشد",
            sInfo: "",
            sInfoEmpty: "",
